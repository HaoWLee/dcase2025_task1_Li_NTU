...
def get_teacher_avg_ensemble(teachers_list=[], teachers_path="teacher_models"):
    ...
    #models_list = [get_model(arch="passt_s_swa_p16_128_ap4761", fstride=10,
                             #tstride=10, n_classes=10) for _ in teachers_list]  
    #models_list = [get_model(arch="passt_s_swa_p16_s16_128_ap473", fstride=10,
                             #tstride=10, n_classes=10) for _ in teachers_list]
    #models_list = [get_model(arch="passt_s_swa_p16_s14_128_ap471", fstride=10,
                             #tstride=10, n_classes=10) for _ in teachers_list]                                                
    models_list = [get_model(arch="passt_s_f128_20sec_p16_s10_ap474", fstride=10,
                             tstride=10, n_classes=10) for _ in teachers_list]
